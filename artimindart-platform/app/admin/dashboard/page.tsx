      ...
      <head>
        ...
        <style>{`
          ...
          *{box-sizing:border-box}
          ...
          .logout-btn{padding:10px 20px;background:var(--bg-2);border:1px solid var(--line);color:var(--ink);border-radius:6px;font-family:var(--sans);font-weight:500;font-size:14px;cursor:pointer;transition:border .2s;}
          .logout-btn:hover{border-color:var(--neon)}
          .container{max-width:1200px;margin:0 auto}
          h1{font-family:var(--display);font-weight:600;font-size:32px;margin:0 0 12px;letter-spacing:-.01em;}
          .subtitle{color:var(--ink-dim);font-size:16px;margin:0 0 32px;}
          .dashboard-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:20px;margin-bottom:40px;}
          .card{padding:24px;border:1px solid var(--line);background:var(--bg-2);border-radius:12px;}
          .card h2{font-family:var(--display);font-weight:600;font-size:18px;margin:0 0 8px;}
          .card p{color:var(--ink-dim);font-size:14px;margin:0;}
          .info{background:var(--bg);padding:16px;border-radius:6px;font-size:13px;color:var(--ink-dim);line-height:1.6;border:1px solid var(--line);margin-top:24px;font-family:'JetBrains Mono',monospace;}
        `}</style>
      </head>
      <body>
        ...
        <div className="container">
          ...
          <div className="info">
            <strong>Token:</strong> {token && <span>{token}</span>}
          </div>
        </div>
      </body>
    </html>
